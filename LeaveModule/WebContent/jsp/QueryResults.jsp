...
<script language="javaScript" type="text/javascript" src="js/workingdays.js"></script>
...
<td><a href="#" title="holidaylist" onclick="javascript:go('holidaylist.do');" class="button_example">HOLIDAY LIST</a></td>
</tr>
<br>
<br>
...
<td>
	...
	<option value="${i.leaveTypeId}"${i.leaveTypeId == leaveTypeId? 'selected' : ''}>${i.leaveType}</option>
	</c:forEach>
	</select>
</td>
...
<td>
       <input type="text" name="fromdate" id="fromdate" style="width: 91px;" >
      <a href="#" onClick="setYears(2000, 2020); 
...
<td>
       <input  type="text" name="todate" id="todate"  style="width: 91px; " >
      <a href="#" onClick="setYears(2000, 2020); 
...
<td>No. of Days</td>
<td width="23%">
		<input type="text" size="3" name="leaveAvailed" id="leaveAvailed" class="leaveBean" align="right" value="0" readonly="readonly" style="background: silver; z-index: 5;">
		<div class="label" id="halfDayImage"></div>
		</td>
</tr>
<tr>
<br>
<td><input type="button" onclick="getSubmitLeaveReport();" title="Submit" value="APPLY LEAVE" class="button_example"/> </td>
</tr>
</table>
</form:form>
    ...
    </table><td><form:errors path="document_number" cssClass="error" /></td>
<!-- End Calender Script  --> 
